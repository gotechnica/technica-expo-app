    ...
    if (this.state.loggedIn) {
      return (
        SiteWrapper(
          <div className="row">
            <div className="col">
              <AdminWinner projects={this.state.projects} loadProjects={this.loadProjects} logout={this.logout.bind(this)} />
              <AdminSponsor />
            </div>
            <div className="col">
              <AdminProject projects={this.state.projects} loadProjects={this.loadProjects} loadChallenges={this.loadChallenges} challenges={this.state.challenges} />
            </div>
          </div>
        )
      );
