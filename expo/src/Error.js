...
class Error extends Component {
  render() {
    let font_awesome_icon = this.props.icon === undefined ? faExclamationTriangle : this.props.icon;
    let className = this.props.iconstyle === undefined ? "fa-exclamation-triangle" : this.props.iconstyle;
    return(
