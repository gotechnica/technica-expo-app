...
MONGO_HOST = 'uri-to-connect-to-your-db-including-username-and-password'  # e.g. 'mongodb://expo-app-user:an38N4o*121L4@ds261460.mlab.com:61460/expo-app' (if using mLab)
