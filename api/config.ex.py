...
MONGO_HOST = 'uri-to-connect-to-your-db-including-username-and-password'  # e.g. 'mongodb://<dbuser>:<dbpassword>@ds261460.mlab.com:61460/expo-app' (if using mLab) or 'mongodb://admin:password@db:27017/expo-testing?authSource=admin' for local development
